...
const Sidebar = () => {
	...
	return (
		<div className='md:flex-[2_2_0] w-18 max-w-52'>
			<div className='sticky top-0 left-0 h-screen flex flex-col border-r border-gray-300 w-20 md:w-full bg-white shadow-lg'>
				<Link to='/' className='flex justify-center py-4'>
					<XSvg className='w-24 h-24 rounded-full fill-black hover:bg-gray-200' />
				</Link>
				<ul className='flex flex-col gap-3 mt-4'>
					<li className='flex justify-center md:justify-start'>
						...
						>
							<MdHomeFilled className='w-8 h-8 text-black' />
							<span className='text-lg hidden md:block text-black'>Home</span>
						</Link>
					</li>
					<li className='flex justify-center md:justify-start'>
						<Link
							...
							className='flex gap-3 items-center hover:bg-gray-200 transition-all rounded-full duration-300 py-2 pl-2 pr-4 max-w-fit cursor-pointer'
						>
							<IoNotifications className='w-6 h-6 text-black' />
							<span className='text-lg hidden md:block text-black'>Notifications</span>
						</Link>
					</li>
					...
					<li className='flex justify-center md:justify-start'>
						...
						>
							...
							<span className='text-lg hidden md:block text-black'>Profile</span>
						</Link>
					</li>
				</ul>
				{authUser && (
