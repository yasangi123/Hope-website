...
const SignUpPage = () => {
  ...
  // useMutation hook to handle signup mutation
  const { mutate, isError, isPending, error } = useMutation({
    // async function to perform signup
    mutationFn: async ({ email, username, fullName, password }) => {
      try {
        ...
        // Returning data in case of successful signup
        return data;
      } catch (error) {
    ...
    // onSuccess callback to show success toast and invalidate authUser query
    onSuccess: () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    mutate(formData); // Triggering signup mutation with form data
  };
